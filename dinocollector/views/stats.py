...
class StatsView(discord.ui.View):
    ...
    async def achievements_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(title=f"Achievements: {self.target.display_name}", color=discord.Color.gold())
        ...
        for ach_id, data in achievement_library.items():
            if ach_id not in unlocked_ids:
                ...
                locked_description += f"**???**\nHint: {hint}\n\n"
        
        embed.description = f"**Unlocked: {count}/{total_achievements}**\n\n"
