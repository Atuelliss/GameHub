...
class GuildSettings(Base):
    ...
    is_mug_enabled: bool = False        # Mugging enabled/disabled
    ...
    # In-Game Bank functions(Not discord Bank/Currency conversion)
    is_bank_enabled: bool = False      # Bank feature enabled/disabled
    bank_interest_rate: float = 0.39  # Interest rate for bank deposits
    bank_max_withdraw: int = 1000000   # Max withdrawal limit per transaction
    
    # Economy value settings (per-guild configurable)
    bar_value: int = 2500              # Value of gold bars in cash
    gem_value: int = 5000              # Value of gems in cash
    gem_conversion_value: int = 3000   # Value when converting gems to Discord currency
